...
export const IntroMapDataViz = () => {
   return (
     ...
     <img src="satellite.png" alt="satellite" className="full" />
     ...
     <img src="traditional.png" alt="traditional" className="full" />
     ...
     <img src="minimal.png" alt="minimal" className="full" />
     ...
     <img src="point.png" alt="point" className="full" />
     ...
     <img src="polyline2.png" alt="polylines" className="full" />
     ...
     <img src="choropleth.png" alt="choropleth" className="full" />
     ...
     <h2 id="bins">Bins</h2>
     <img src="bins.png" alt="bins" className="full" />
     ...
     <img src="heatmap.png" alt="heatmap" className="full" />
     ...
     <img src="hue.png" alt="hue" className="non-full" />
     ...
     <img src="continuous.png" alt="continuous" className="non-full" />
     ...
     <img src="symbols.png" alt="symbol" className="non-full" />
     <h2 id="size">Size</h2>
     <p>When it comes to quantitative data, size encoding works well in map visualizations.</p>
     <img src="size.png" alt="symbol" className="non-full" />
     ...
     <img src="extrusion.png" alt="extrusion" className="full" />
     ...
     <img src="pitch.png" alt="pitch" className="full" />
     ...
     <img src="tooltip.png" alt="tooltip" className="non-full" />
